...
const RandomColorGenerator = () => {
  ...
  useEffect(() => {
    const randomColor = generateRandomColor(); // Generate only on client
  ...
  return (
    <div className="w-full h-screen flex flex-col items-center justify-center pb-10" style={{ backgroundColor: color }}>
      ...
      <div className="flex flex-col items-center justify-center mt-5">
        ...
        <button
          className="mt-6 text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-lg px-5 py-2.5 cursor-pointer"
